...
import { Row, Col, Typography, Form, Input, Button, Space, message } from "antd";
	...
	return (
		<Col className="CreateProfile" span={24}>
			<Row justify="center" style={{ overflow: "hidden", width: "100%" }}>
				...
				<Col xs={{ span: 20 }} sm={{ span: 18 }} md={{ span: 16 }} lg={{ span: 14 }} xl={{ span: 12 }} className="profileForm">
					...
					>
						...
						<Col span={24}>
							...
							>
								<Input.TextArea name="about" onChange={handleChange} value={values.about} />
							</Form.Item>
						</Col>
						...
						<Col span={24}>
							...
							>
								<Input name="socials.twitter" onChange={handleChange} value={values.socials.twitter} />
							</Form.Item>
						</Col>
						...
						<Col span={24}>
							...
							>
								<Input name="socials.gitlab" onChange={handleChange} value={values.socials.gitlab} />
							</Form.Item>
						</Col>
						...
						<Col span={24}>
							...
							>
								<Input name="socials.github" onChange={handleChange} value={values.socials.github} />
							</Form.Item>
						</Col>
						...
						<Col span={24}>
							...
							>
								<Input name="socials.linkedin" onChange={handleChange} value={values.socials.linkedin} />
							</Form.Item>
						</Col>
						...
						<Col span={24}>
							...
							>
								<Input name="socials.behance" onChange={handleChange} value={values.socials.behance} />
							</Form.Item>
						</Col>
						...
						<Col span={24}>
							...
							>
								<Input name="socials.codepen" onChange={handleChange} value={values.socials.codepen} />
							</Form.Item>
						</Col>
